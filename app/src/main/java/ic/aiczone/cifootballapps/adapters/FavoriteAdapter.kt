...
class FavoriteAdapter(private val favorite: List<Event>,
                      private val listener: (Event) -> Unit): RecyclerView.Adapter<FavoriteAdapter.ViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ScheduleUI().createView(AnkoContext.create(parent.context, parent)))
    }
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        fun bindItem(favorite: Event, listener: (Event) -> Unit){
